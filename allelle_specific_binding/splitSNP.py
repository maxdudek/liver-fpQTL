...
"""
Downloaded from https://github.com/astatham/splitSNP
Written by Aaron Statham
"""
...
def main():
    ...
    # Dudek - write to summary file
    summary_file = open("splitSNP_summary.txt", "a")
    summary_file.write("\t".join([args.output_prefix.split("/")[-1], chrom, str(pos), ref, alt, str(ref_count), str(alt_count)]) + "\n")
    summary_file.close()
